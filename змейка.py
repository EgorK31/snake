...
class Game():
    ...
    def set_surface_and_title(self):
        ...
        self.play_surface2 = pygame.display.set_mode((
            self.screen_width, self.screen_height))        
    ...
    def show_score(self, choice = 1):
        ...
        s_font = pygame.font.SysFont('font', 24)
        s_surf = s_font.render(
            'Счёт: {0}'.format(self.score), True, self.black)
        s_rect = s_surf.get_rect()
        # обычный случай отображаем результат справа сверху
        if choice == 1:
    ...
    def game_over(self):
        ...
        go_font = pygame.font.SysFont('font', 72)
        go_surf = go_font.render('Game over', True, self.black)
        go_rect = go_surf.get_rect()
        go_rect.midtop = (360, 40)
...
class Snake():
    def __init__(self, snake_color):
        ...
        self.snake_head_pos = [100, 100]  # [x, y]
        # начальное тело змеи состоит из трех сегментов
        # голова змеи - первый элемент, хвост - последний
        self.snake_body = [[100, 60], [100, 60], [100, 60]]
        self.snake_color = pygame.Color(255, 30, 0)
    ...
    def change_head_position(self):
        ...
        if self.direction == "RIGHT":
            self.snake_head_pos[0] += 20
        elif self.direction == "LEFT":
            self.snake_head_pos[0] -= 20
        elif self.direction == "UP":
            self.snake_head_pos[1] -= 20
    ...
    def draw_snake(self, play_surface, surface_color):
        ...
        play_surface.fill(pygame.Color(0, 200, 0))
...
class Food():
    def __init__(self, food_color, screen_width, screen_height):
        """Инит еды"""
        self.food_color = pygame.Color(255, 255, 0)
        self.food_size_x = 20
        self.food_size_y = 20
        self.food_pos = [random.randrange(1, screen_width // 20) * 20,
                         random.randrange(1, screen_height // 20) * 20]
